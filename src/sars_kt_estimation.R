...
input <- read_rds(file = "code/empirical/finished scripts/data/sars_dated_offspring.rds")
...
bind_rows(output_daily, output_sliding7, output_sliding14) |> 
  saveRDS(file = "code/empirical/processed/sars_estimates_nbinom_new.rds")
...
bind_rows(output_daily, output_sliding7, output_sliding14) |> 
  saveRDS(file = "code/empirical/processed/sars_estimates_mixture.rds")
